    ...
    <div class="header-top container-fuild hidden-xs">
      <div class="container">
        <div class="server pull-left">
          <span class="glyphicon glyphicon-earphone"></span>400-111-2424
          <span class="glyphicon glyphicon-envelope"></span>postmaster@24ud.cn
...
#header .header-nav .header-nav-wrapper > li.active > a {
  color: #181d7e;
  text-decoration: none;
  border-bottom: 2px solid #181d7e;
}
/* 导航栏 每个导航下面的二级导航容器 */
